    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> AddDepartment(Department department)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    department.Id = 0; country.Departments.Add(department);
